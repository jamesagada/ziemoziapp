 ...
 * @author jamesagada
 */
public class UrlEditor extends BaseEditorImpl{
    ...
    public UrlEditor(){
        ...
        headerContainer.setLayout(new BoxLayout(BoxLayout.X_AXIS));
         ...
         editorConstraints.add(TextArea.URL);
         textField.setConstraint(TextArea.URL);
         Validator val = new Validator();
        val.addConstraint(textField, RegexConstraint.validURL());
