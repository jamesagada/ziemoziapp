 ...
 * @author jamesagada
 */
public class PhoneNumberEditor extends BaseEditorImpl{
    ...
    public PhoneNumberEditor(){
        ...
        headerContainer.setLayout(new BoxLayout(BoxLayout.X_AXIS));
         ...
         editorConstraints.add(TextArea.PHONENUMBER);
         textField.setConstraint(TextArea.PHONENUMBER);
         Validator val = new Validator();
        val.addConstraint(textField, new Constraint() {
