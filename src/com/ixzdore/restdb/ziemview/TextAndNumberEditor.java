 ...
 * calculated
 */
public class TextAndNumberEditor extends BaseEditorImpl {
    ...
    public String[] optionArray;
        TextAndNumberEditor selfref;
    //Component selfref;    
    public TextAndNumberEditor() {
    ...
    public Container edit(ServiceAttribute attr) {
        ...
        textField.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                requestParameter.value.set(textField.getText() + "," + numberField.getText());                
        ...
        selectContainer.add(textField).add(numberField);
