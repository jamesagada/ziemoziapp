 ...
 * calculated
 */
public class SelectAndNumberEditor extends BaseEditorImpl {
    ...
    public String[] optionArray;
        SelectAndNumberEditor selfRef;
    Component selfref;    
    public SelectAndNumberEditor() {
        ...
        selectContainer.setLayout(new BoxLayout(BoxLayout.X_AXIS));
