 ...
 * @author jamesagada
 */
public class LocationEditor extends BaseEditorImpl {
    ...
    public final MapContainer mapView = new MapContainer(
            "AIzaSyAQ_DYgORK1Lvq6js7SbdTO908OnsfQ-28");
    public static String MAP_API_KEY = "AIzaSyAQ_DYgORK1Lvq6js7SbdTO908OnsfQ-28";
        //"AIzaSyDKDcbchGoq1NyuOipeClZKpyeFvlXI2yg";
    ...
    public static void getFormattedAddressAsync(Coord coord, Callback callback) {
        ConnectionRequest request = new ConnectionRequest(
                "https://maps.googleapis.com/maps/api/geocode/json", false) {
            @Override
