 ...
 * @author jamesagada
 */
public class BooleanEditor extends BaseEditorImpl {
    ...
    public final PickerComponent booleanPicker = PickerComponent.createStrings("Yes","No");
    ...
    public BooleanEditor() {
      ...
      //  datePicker.getPicker().setDate(new Date());
        ...
        booleanPicker.getPicker().setSelectedString(serviceAttribute.default_value.get());
    }
    ...
    public Container edit(ServiceAttribute attr) {
        ...
        if (this.requestParameter == null) {
            ...
            if (requestParameter.value.get() == null){
        ...
        headerContainer.setLayout(new GridLayout(2));
