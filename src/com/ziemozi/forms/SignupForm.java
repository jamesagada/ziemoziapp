...
public class SignupForm extends Form {
    ...
    protected SignupForm(String title, String backLabel, Form previous) {
        ...
        problem.addActionListener(e -> 
                sendMessage("Problem with Ziemozi", 
                        new Message("Details..."), 
                        "james.agada@ziemozi.com"));
        add(SOUTH, south);
    }
    ...
    public static SignupForm createTerms() {
        ...
        RichTextView rt = new RichTextView("By signing up you agree to our "
                + "<a href=\"terms\">Ziemozi Terms</a> and that you have "
    ...
    private static SignupForm createMobileOrEmail(User currentUser, 
        ...
        textEntry.getField().setText(Display.getInstance().getMsisdn());
            ...
            s.createNextButton(e -> {
                ...
                ServerAPI.signup(currentUser, new Callback<User>() {
                    ...
                    public void onSucess(User result) {
                        dlg.dispose();
                        createConfirmation(currentUser, phone, value,uib).show();
                        ToastBar.showInfoMessage("Success. Now confirm ...");
                    }

                    @Override
                    public void onError(Object sender, Throwable err, int errorCode, String errorMessage) {
                        dlg.dispose();
                        ToastBar.showErrorMessage("Signup failed ");
                    }
                });
            }));
        return s;
    ...
    public static SignupForm createConfirmation(
                User currentUser, boolean phone, String value, UiBinding uib) {
        ...
        textContainer.add(confirm);
         Button repeat = s.createNextButton(e -> 
        ...
        s.content.addAll(title, line, textContainer, done,repeat);
        return s;
    }
}
