...
public class ContactForm extends Form {
    ...
    public ContactForm(ServiceContact p) {
    ...
    private Container createContactItem(ServiceContact p) {
        ...
        like.addActionListener(e -> rateContact(p));
     ...
     private static Container createTitle(ServiceContact p) {
       ...
       menu.addActionListener(e -> new ContactForm(p).show());
    ...
    private void rateContact(ServiceContact p) {
    ...
    private void requestService(ServiceContact p) {
        ...
        p.refresh();
                    ...
                    ArrayList<Category> c = p.getCategoryList();
                   if (!s.isEmpty() ){
                    ipd.dispose();
                    ip.remove();
