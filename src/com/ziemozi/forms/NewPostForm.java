...
public class NewPostForm extends Form {
    ...
    private void initUI(Container postStyles) {
        ...
        //just replace post with the ziemview container for editing
        //
        Component l;
        if(postStyles != null) {
        ...
        //Or just create the ziemview here and add it. 
        //the issue is how do we take care of categories and providers?
        //Chose a category -- then a service
        //chose a provider -- then a service
        //chose service group -- then select 
        //so we will have a form that shows list of these and then 
        //we click on them to go into a ziemview
        add(CENTER, l);
        setEditOnShow(post);        
    }
